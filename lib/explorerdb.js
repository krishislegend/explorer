...
function update_wanaddress(hash, txid, amount, type, balances, cb) {
		...
		timestamp: block_timestamp,
            ...
            newtx.save(function(err) {
                if (err) {
                    ...
                    update_wanaddress(tx.from, tx.hash, 1, 'send', balances, function(err) {
                        console.log(err);
                        if (err) {
                            return cb(err);
                        } else {
                            ...
                            update_wanaddress(tx.to, tx.hash, 1, 'receive', balances, function(err) {
                                if (err) {
                                    return cb(err);
                                } else {
